...
//  All above are use to import images
const assets = {
    avatar_icon,
    gallery_icon,
    help_icon,
...
//  the all the above are exported are in one array assets so it can be call anywhere where we want 
// import assets from './assets'; // due to constant assets value get fixed
// <img src={assets.avatar_icon} />

export default assets;
// this down below show the dummy images

export const imagesDummyData = [pic1, pic2, pic3, pic4, pic1, pic2]
// this down below show the dummy data we can write MAnually or either we pick the
